...
Begin VB.MDIForm menuform 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin WMPLibCtl.WindowsMediaPlayer WindowsMediaPlayer1 
         ...
         Visible         =   0   'False
         Width           =   495
         URL             =   "C:\Gerald Riwo KCSE 2011 Project\Other Project files\Flyleaf_There_For_You.mp3"
         rate            =   1
         balance         =   0
         currentPosition =   0
         defaultFrame    =   ""
   ...
   Begin VB.Menu rpts 
      Caption         =   "&Reports"
      Begin VB.Menu mnuagentsrpt 
         Caption         =   "&Agents"
      End
      Begin VB.Menu mnuagentearningsrpt 
         Caption         =   "&Agent  Earnings"
      End
      Begin VB.Menu mnucompanyexpensesrpt 
         Caption         =   "&Company Expenses"
      End
      Begin VB.Menu mnucompanyincomerpt 
         Caption         =   "&Company Income"
      End
      Begin VB.Menu mnuemployeesrpt 
         Caption         =   "&Employees"
      End
      Begin VB.Menu mnuestatesrpt 
         Caption         =   "&Estates"
      End
      Begin VB.Menu mnulandlordsrpt 
         Caption         =   "&Landlords"
      End
      Begin VB.Menu mnuremittancerpt 
         Caption         =   "&Remittance"
      End
      Begin VB.Menu mnurentpaymentrpt 
         Caption         =   "&Rent Payment"
      End
      Begin VB.Menu mnutenancyagreementrpt 
         Caption         =   "&Tenancy Agreement"
      End
      Begin VB.Menu mnutenantsrpt 
         Caption         =   "&Tenants"
      End
   End
...
Shell "C:\Program Files\Microsoft Office\Office12\excel"
End Sub
